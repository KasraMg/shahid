...
const Header = (_props: Props) => {
  return ( 
    <header dir="rtl" className="flex w-full flex-col items-center  pl-[86px] pt-12 sm:!pl-4 lg:pl-7 lg:pt-3.5">
      ...
      <div className="logo flex items-center rounded-[692.1px_0_0_692.1px] bg-white gap-2 lg:!py-1 py-1 pl-14 pr-10 lg:rounded-[516.04px_0_0_516.04px] lg:p-2 lg:pl-10 sm:!px-4 lg:pr-7">
          <img
            src="/images/logo.svg"
            alt="logo"
