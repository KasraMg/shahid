...
const Topbar = () => {
  return (
    <header dir="rtl" className="flex w-full flex-col items-center  pl-[86px] pt-12 lg:pl-7 lg:pt-3.5">
    <div className="header-container flex w-full items-center justify-between">
      ...
      <button className="Record_your_memories rounded-[66.03px] border border-[#381B00] bg-transparent px-11 pb-2 pt-3 text-[19.52px] text-[#381B00] lg:rounded-[37.18px] lg:px-6 lg:pt-2 lg:pb-0.5 lg:text-[11px]">
      شاهین مشکل گشا
      <p className='text-base text-orange-600 lg:text-xs'>ادمین</p>
      </button>
    </div>
